...
public class SolveAdminAdapter extends RecyclerView.Adapter<SolveAdminAdapter.ProductViewHolder> {

    private Context mCtx;
    private List<SolveDatabase> productList;

    public SolveAdminAdapter(Context mCtx, List<SolveDatabase> productList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.textViewDate.setText("LastUpdate : "+ product.getDate());
    }
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(mCtx, SolveAdminUpdate.class);
